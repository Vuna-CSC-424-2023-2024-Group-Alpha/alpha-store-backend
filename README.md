...
An Express Boilerplate to quickly start building RESTful APIs using Node.js, Express and Mongoose.

Run a single command to deploy and configure a production-ready Node powered API. This Boilerplate includes built-in features, such as authentication using JWT, request validation, unit and integration tests, continuous integration, docker support, API documentation, pagination and more.
...
The environment variables can be found and modified in the `.env.example` file which includes the following default values:
